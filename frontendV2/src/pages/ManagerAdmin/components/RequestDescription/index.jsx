...
const RequestDescription = () => {
  ...
  const [newStatus, setNewStatus] = useState(null); // Track the status change for confirmation
  ...
  const handleChangeStatus = async (statusValue) => {
    setLoading(true);
    try {
  ...
  const handleStatusChange = (e, option) => {
  ...
  const handleConfirm = () => {
    setStatus(newStatus); 
    handleChangeStatus(newStatus.value); 
  };
  ...
  return loading ? (
    ...
    <div className="w-full flex flex-col gap-3 mb-4 overflow-y-hidden">
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            Status marked as completed cannot be updated again. Do you want to proceed?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
